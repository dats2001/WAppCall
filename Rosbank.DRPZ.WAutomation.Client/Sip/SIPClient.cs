...
namespace Rosbank.DRPZ.WAutomation.Client.Sip
{
    public class SIPClient
    {
        ...
        private static int TRANSFER_RESPONSE_TIMEOUT_SECONDS = 20;

        private string m_sipUsername;
        private string m_sipPassword;
        private string m_sipServer; 
        private string m_sipFromName;
        ...
        private int m_audioOutDeviceIndex = -1;//SIPSoftPhoneState.AudioOutDeviceIndex;
        ...
        public SIPClient(SIPTransport sipTransport, string server, string user, string password)
        {
