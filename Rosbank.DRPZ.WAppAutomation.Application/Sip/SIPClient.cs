...
namespace Rosbank.DRPZ.WAppAutomation.Application.Sip
{
    public class SIPClient
    {
        ...
        private string m_sipUsername = "201";
        private string m_sipPassword = "MgZkogD9";
        private string m_sipServer = "178.154.207.15";
        private string m_sipFromName = "dats2001";
